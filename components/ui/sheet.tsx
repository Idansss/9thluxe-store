...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-[var(--z-drawer)] bg-[var(--overlay)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className,
    )}
    {...props}
    ref={ref}
...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({ side = "right", closeLabel = "Close panel", className, children, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay />
